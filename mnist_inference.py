...
#Deepth and size of conv1
CONV1_DEEP = 32
CONV1_SIZE = 5

#Deepth and size of conv2
CONV2_DEEP = 64
CONV2_SIZE = 5

#Fully connected nn nodes
FC_SIZE = 512

#Interface of FP
def inference(input_tensor, train, regularizer):
#the namespace here is to avoid the variables renamed. 
...
#the output of pool2 transfer to FC layer intput
#the shape of FC layer is [BATCH_SIZE, nodes]
